...
/* drm ioctls */
#define TARGET_DRM_IOCTL_VERSION      TARGET_IOWRU(0x64, 0x00)
#define TARGET_DRM_IOCTL_GET_MAGIC    TARGET_IORU(0x64, 0x02)
#define TARGET_DRM_IOCTL_GET_CLIENT   TARGET_IOWRU(0x64, 0x05)
#define TARGET_DRM_IOCTL_AMDGPU_INFO  TARGET_IOWU(0x64, 0x45)
#define TARGET_DRM_IOCTL_GET_CAP      TARGET_IOWRU(0x64, 0x0c)
#define TARGET_DRM_IOCTL_AMDGPU_GEM_CREATE TARGET_IOWRU(0x64, 0x40)
#define TARGET_DRM_IOCTL_AMDGPU_GEM_VA TARGET_IOWRU(0x64, 0x48)
#define TARGET_DRM_IOCTL_GEM_CLOSE TARGET_IOWU(0x64, 0x09)
#define TARGET_DRM_IOCTL_AMDGPU_CTX TARGET_IOWRU(0x64, 0x42)
#define TARGET_DRM_IOCTL_AMDGPU_GEM_MMAP TARGET_IOWRU(0x64, 0x41)
#define TARGET_DRM_IOCTL_AMDGPU_GEM_METADATA TARGET_IOWRU(0x64, 0x46)
#define TARGET_DRM_IOCTL_PRIME_HANDLE_TO_FD TARGET_IOWRU(0x64, 0x2d)
#define TARGET_DRM_IOCTL_PRIME_FD_TO_HANDLE TARGET_IOWRU(0x64, 0x2e)
#define TARGET_DRM_IOCTL_AMDGPU_BO_LIST	TARGET_IOWRU(0x64, 0x43)
#define TARGET_DRM_IOCTL_AMDGPU_CS	TARGET_IOWRU(0x64, 0x44)
#define TARGET_DRM_IOCTL_AMDGPU_WAIT_CS	TARGET_IOWRU(0x64, 0x49)
