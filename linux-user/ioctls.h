  ...
  IOCTL_SPECIAL(DRM_IOCTL_VERSION, IOC_RW, do_ioctl_drm_ioctl_version, MK_PTR(MK_STRUCT(STRUCT_drm_version)))
  ...
  IOCTL_SPECIAL(DRM_IOCTL_AMDGPU_INFO, IOC_W, do_ioctl_drm_ioctl_amdgpu_info,  MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_info)))
  IOCTL(DRM_IOCTL_GET_CAP, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_get_cap)))
  IOCTL(DRM_IOCTL_GET_CAP, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_get_cap)))
  IOCTL(DRM_IOCTL_AMDGPU_GEM_CREATE, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_gem_create)))
  IOCTL(DRM_IOCTL_GEM_CLOSE, IOC_W, MK_PTR(MK_STRUCT(STRUCT_drm_gem_close)))
  IOCTL(DRM_IOCTL_AMDGPU_GEM_VA, IOC_W | IOC_R, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_gem_va)))
  IOCTL(DRM_IOCTL_AMDGPU_CTX, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_ctx)))
  IOCTL_SPECIAL(DRM_IOCTL_AMDGPU_GEM_MMAP, IOC_RW, do_ioctl_drm_ioctl_amdgpu_gem_mmap, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_gem_mmap)))
  IOCTL(DRM_IOCTL_AMDGPU_GEM_METADATA, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_gem_metadata)))
  ...
  IOCTL_SPECIAL(DRM_IOCTL_AMDGPU_BO_LIST, IOC_RW, do_ioctl_drm_ioctl_amdgpu_bo_list, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_bo_list)))
  IOCTL_SPECIAL(DRM_IOCTL_AMDGPU_CS, IOC_RW, do_ioctl_drm_ioctl_amdgpu_cs, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_cs)))
  //IOCTL(DRM_IOCTL_VERSION, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_version)))
  IOCTL(DRM_IOCTL_AMDGPU_WAIT_CS, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_amdgpu_wait_cs)))
